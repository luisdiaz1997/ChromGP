#!/bin/bash
# Run SVGP pipeline for assigned chromosomes on a specific GPU.
# Usage: run_svgp_chromosomes.sh <GPU_ID> <START_CHR> <END_CHR>
#
# Example:
#   run_svgp_chromosomes.sh 0 1 11   # chr1-11 on GPU 0
#   run_svgp_chromosomes.sh 1 12 22  # chr12-22 on GPU 1
...
echo "======== GPU $GPU_ID: chr${START} through chr${END} ========"
